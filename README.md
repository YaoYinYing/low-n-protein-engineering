...
## Low-N engineering of P450 
_Added by Yinying Yao_
1. Pre-evotuning: [sequence fetching and profiling](./Low_N_engineering_pre-evotuning.ipynb)
2. E-UniRep: [Evotuning and hyperparamter selection](./Low-N_engineering_evotuning_hyperparameter_training.ipynb)
3. Directed-Evolution: [Serial for small fractions](./Low-N_engineering_directed_evolution_colab_serial.ipynb) or [parallel version for large fractions](./Low-N_engineering_directed_evolution_parallel.ipynb)
